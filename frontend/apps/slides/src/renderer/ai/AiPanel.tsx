...
/** File-type icons for attachment cards (AI Office attachment icon set); exts the
...
interface ChatEntry {
  ...
  undelivered?: boolean
  /** the run failed because AI Office is signed out — render an inline sign-in button */
...
export function AiPanel({
  ...
  /** data-URL previews for image attachments, keyed by path (AI Office composer thumbnails) */
