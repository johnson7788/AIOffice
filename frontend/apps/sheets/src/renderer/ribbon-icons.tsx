...
/** AI Office brand mark (blue rounded-square "AI" badge), inline so it renders
 * crisply at device resolution instead of going through <img> rasterization.
 * Matches the docs/slides AiOfficeMark. */
export function AiOfficeMark({ size = 18 }: { readonly size?: number }): ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden
    >
      <rect width="130" height="130" rx="28" fill="#2563EB" />
      <text
        x="65"
        y="66"
        textAnchor="middle"
