export const strings = {
  zh: {
    ...
    aiCreditsExhausted: '积分不足，请前往 AI Office 充值',
  ...
  en: {
    ...
    aiCreditsExhausted: 'Out of credits — top up at AI Office',
  ...
  ja: {
    ...
    aiCreditsExhausted: 'クレジット不足です。AI Office でチャージしてください',
  ...
  ko: {
    ...
    aiCreditsExhausted: '크레딧이 부족합니다. AI Office에서 충전하세요',
  ...
  fr: {
    ...
    aiCreditsExhausted: 'Crédits épuisés — rechargez sur AI Office',
  ...
  de: {
    ...
    aiCreditsExhausted: 'Guthaben aufgebraucht — bei AI Office aufladen',
  ...
  es: {
    ...
    aiCreditsExhausted: 'Sin créditos — recarga en AI Office',
  ...
  th: {
    ...
    aiCreditsExhausted: 'เครดิตหมด — เติมได้ที่ AI Office',
  ...
  id: {
    ...
    aiCreditsExhausted: 'Kredit habis — isi ulang di AI Office',
  ...
  ru: {
    ...
    aiCreditsExhausted: 'Кредиты закончились — пополните на AI Office',
  ...
  ar: {
    ...
    aiCreditsExhausted: 'نفدت الأرصدة — أعد الشحن على AI Office',
  ...
  pt: {
    ...
    aiCreditsExhausted: 'Créditos esgotados — recarregue em AI Office',
  ...
  it: {
    ...
    aiCreditsExhausted: 'Crediti esauriti — ricarica su AI Office',
  ...
  pl: {
    ...
    aiCreditsExhausted: 'Brak kredytów — doładuj na AI Office',
  ...
  nl: {
    ...
    aiCreditsExhausted: 'Credits op — waardeer op via AI Office',
  ...
  ms: {
    ...
    aiCreditsExhausted: 'Kredit habis — tambah nilai di AI Office',
  ...
  he: {
    ...
    aiCreditsExhausted: 'נגמרו הקרדיטים — טענו ב-AI Office',
  ...
  hi: {
    ...
    aiCreditsExhausted: 'क्रेडिट समाप्त — AI Office पर रिचार्ज करें',
  ...
  'zh-TW': {
    ...
    aiCreditsExhausted: '點數不足，請前往 AI Office 儲值',
