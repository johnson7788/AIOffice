// Ported from genoffice apps/pdf/src/main/save-pdf.ts, verbatim except the
// fs-based savePdfToPath (dropped — the web adapter reads/writes blobs over HTTP).
// applySaveRequest / extractPagesBytes / insertPdfBytes are pure pdf-lib (browser-safe).
import {
  PDFArray,
  PDFBool,
  PDFDocument,
